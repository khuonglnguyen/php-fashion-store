...
<body>
  ...
  <div class="slideshow-container">
    ...
    <div class="mySlides fade">
      ...
      <img src="<?= URL_ROOT ?>/public/images/banner1.jpg" style="width:100%;">
    </div>

    <div class="mySlides fade">
      <div class="numbertext">2 / 3</div>
      <img src="<?= URL_ROOT ?>/public/images/banner2.jpg" style="width:100%;">
    </div>
    ...
    if (count($data['FeaturedproductsList']) > 0) {
      foreach ($data['FeaturedproductsList'] as $key) { ?>
        <div class="card">
          ...
          <a href="<?= URL_ROOT . '/product/single/' . $key['id'] ?>" style="text-align: center;">
            <h3><?= $key['name'] ?></h3>
          </a>
          <?php
          if ($key['promotionPrice'] < $key['originalPrice']) { ?>
